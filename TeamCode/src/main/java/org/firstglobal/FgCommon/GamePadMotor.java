...
public class GamePadMotor extends OpModeComponent {
     ...
     */
    public GamePadMotor(FGOpMode opMode, Gamepad gamepad, DcMotor motor, Control control) {
     ...
     */
    public GamePadMotor(FGOpMode opMode, Gamepad gamepad, DcMotor motor, Control control,float buttonPower) {
